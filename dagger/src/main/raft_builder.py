"""Serve faiss-gpu-raft building function using dagger pipeline.
...
from .type import AuditWheelConfig, BuildConfig, CUDAConfig, PythonConfig, RAFTConfig
    ...
    async def build(self) -> Container:
        ...
        builder = self._host_directory.docker_build(
            ...
            build_args=[
                ...
                BuildArg("RAFT_VERSION", self._raft_config["version"]),
...
class WheelBuilder(AbsWheelBuilder):
    ...
    async def build(self, python_target_version: str) -> File:
        ...
        builder = (
            ...
            .with_env_variable("RAFT_VERSION", self._raft_config["version"])
...
class WheelName:
    ...
    def make_raw_wheelname(self, python_version: str) -> str:
        ...
        name_parts = [
            f"faiss_gpu_raft_cu{self._cuda_major_version}",
            self._faiss_version,
            python_version,
            python_version,
